...
namespace ProyectoDeteccionBalas.Datos
{
    public class BDUsuario
    {
        private static string CadenaSQL = "Server=(local); DataBase=DeteccionBalas; Trusted_Connection=True; TrustServerCertificate=True;";
